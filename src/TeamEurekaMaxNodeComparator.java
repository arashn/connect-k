 ...
 * CS 171 Winter 2015
 * 
 * The TeamEurekaMaxNodeComparator class is a comparator that is used
 * for ordering children of max nodes in order of decreasing heuristic
 * value. It implements the Comparator interface.
 */
import java.util.Comparator;
public class TeamEurekaMaxNodeComparator implements Comparator<TeamEurekaStateNode> {
	@Override
